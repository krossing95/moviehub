        ...
        <Card className={classes.card}>
            <CardActionArea >
                ...
                <div className={classes.details}>
                    ...
                    <Typography variant="body2" color="textSecondary" component="h2">MOVIE</Typography>
                </div>
            ...
            <CardActions className={classes.cardActions}>
                <Button size="large" onClick={() => openInYoutube('movie', id)} color="secondary"><YouTubeIcon /> <span id={`vid-${id}`}>Trailer</span></Button>
