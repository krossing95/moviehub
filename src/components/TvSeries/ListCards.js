...
const ListCards = ({ i, result:{id, poster_path, vote_average, original_title, original_name, release_date, title, first_air_date} }) => {
        ...
        <Card className={classes.card}>
            <CardActionArea >
                ...
                <div className={classes.details}>
                    ...
                    <Typography variant="body2" color="textSecondary" component="h2">TV SERIES</Typography>
                </div>
            ...
            <CardActions className={classes.cardActions}>
                <Button size="large" onClick={() => openInYoutube('tv', id)} color="secondary"><YouTubeIcon /> <span id={`vid-${id}`}>Trailer</span></Button>
